    ...
    <div class="row ">
      <div class="col-12">
        <div class="card h-100">
          <img src="http://localhost/ProyectoGTH_V1.0_/libs/bootstrap-icons/people-fill.svg" class="card-img-top"
            alt="person-plus" width="90px" height="90">
          <div class="card-body">
            <h5 class="card-title">Inicio de sesión</h5>

            <form action="http://localhost/ProyectoGTH_V1.0_/configuracion/controller/login.php?correo=email"
              ...
              <div class="form-floating m-4">
                <input type="password" class="form-control" id="password" placeholder="Ingrese su Email" name="password"
                  required>
                <label for="password"><i class="bi bi-lock">Password</i></label>
              </div>
          </div>
          <div class="btn-group">
            <button type="submit" name="submit" class="btn btn-secondary m-5"><i
