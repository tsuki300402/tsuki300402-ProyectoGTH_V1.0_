        ...
        function inicio(){
            ...
            while ($fila = mysqli_fetch_assoc($resultado)) {
                if($fila['rol']=="Administrador"){
                    ...
                    header("Location: http://localhost/ProyectoGTH_V1.0\proyecto\admin\categoria\categoriaAdmin.php");
                }else{
                    $_SESSION['Usuario']=$fila['nombre'];
                    $_SESSION['idUsuario']=$fila['idUsuario'];
                    header("Location: http://localhost/ProyectoGTH\proyecto\admin\categoria\categoriaUser.php");
                }
