        ...
        <tbody class="text-center">
          ...
          while ($libro = mysqli_fetch_assoc($resultset)) {
            ...
            <tr id="<?php echo $libro['id_usuario']; ?>">
              ...
              <td>
                <?php echo $libro['nivel de prueba']; ?>
              </td>
              ...
              <td><a class="btn btn-success fa fa-share-square"
                  href="../../controlador/phpmailer/enviarC.php?CorreoA='<?php echo $libro['id_usuario']; ?>'">Enviar
                  correo contratado</a></td>
              <td><a class="btn btn-danger fa fa-share-square"
                  href="../../controlador/phpmailer/enviarCNO.php?CorreoA='<?php echo $libro['id_usuario']; ?>'">Enviar
                  correo no contratado</a></td>
            </tr>
          <?php } ?>
          <?php ?>
        </tbody>
