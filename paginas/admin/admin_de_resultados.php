        ...
        <tbody class="text-center">
          <?php
                          ...
                          ?>
                             ...
                             <td><a class="btn btn-primary fa fa-download" href="../../controlador/pdf.php?id='<?php echo $libro ['id_usuario'] ?>'">Descarga de pdf</a></td>   
                             <td><a class="btn btn-primary fa fa-eye" href="../../controlador/mpdf/pdf/index.php?id='<?php echo $libro ['id_usuario'] ?>'">Ver el pdf</a></td>   
